...
\begin{document}
	...
	\begin{table}[h!]
		...
		\begin{tabularx}{0.9\textwidth}{|>{\centering\arraybackslash}m{0.05\linewidth}|>{\centering\arraybackslash}m{0.35\linewidth}|>{\centering\arraybackslash}m{0.4\linewidth}|>{\centering\arraybackslash}m{0.15\linewidth}|}
			...
			\hline
			ATP7 & Physical Size & The power supply unit should be within the range 0.15x0.15m. & - \\
			\hline
			ATP8 & Overloading current & The power supply should not draw a current of more than 0.052A. & \textbf{PASSED}. The results show that the current reduced from 0.15A to below 0.0152A. \\
			\hline
			ATP9 & Charging circuit & The battery should be able to charge with a voltage of 5V. & \textbf{PASSED}. \\
			\hline
			ATP10 & Compatibility & The power supply unit should be able to get supply from different types of power sources. & \textbf{PASSE
				
	\section{Testing and Results}
	The circuit below follows the design outlined following the LED charging indicators. When the battery is fully charged, the Green LED will be more dominant than the RED LED. This simple LED indicator will assist in monitoring the charging of the batteries.
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.5\linewidth]{Figures/Battery chargerG.jpg}
		\caption{Charging circuit}
		\label{fig: P5}
	...
	\end{figure}
		\begin{figure}[h!]
		\centering
		\includegraphics[width=0.5\linewidth]{Figures/Battey voltageC.jpg}
		\caption{Charging circuit}
		\label{fig: P6}
	\end{figure}
	\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{Figures/Overloading current.jpg}
	\caption{Charging circuit}
	\label{fig: P7}
	\end{figure}
	Overload and under-load protection
		\begin{figure}[h!]
		\centering
		\includegraphics[width=0.5\linewidth]{Figures/OverloadAndUnderloadProtection.jpg}
		\caption{Charging circuit}
		\label{fig: P8}
	\end{figure}
