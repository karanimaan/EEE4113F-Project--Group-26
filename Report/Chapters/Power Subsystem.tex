...
\begin{document}
	...
	The circuit below follows the design outlined following the LED charging indicators. When the battery is fully charged, the Green LED will be more dominant than the RED LED. This simple LED indicator will assist in 
	\begin{figure}[h!]
		\centering
	...
	Overload and under-load protection
		\begin{figure}[h!]
		\centering
		\includegraphics[width=0.6\linewidth]{Figures/OverloadAndUnderloadProtection.jpg}
		\caption{Charging circuit}
		\label{fig: P8}
	\end{figure}
